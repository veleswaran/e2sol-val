...
function initAffixSidebar() {
    ...
    if ($affixAside.length) {
        ...
        // Function to handle affix adjustments
        ...
        // Function to handle affix bottom event
        function handleAffixBottom() {
            var affixWidth = $affixAside.width() - 1;
            var stickedSideHeaderWidth = 0;
            var $stickedSideHeader = $('.header_side_sticked');
        ...
        // Event listeners
        $affixAside.on('affix.bs.affix', adjustAffix)
                    .on('affix-bottom.bs.affix', handleAffixBottom)
        ...
        $window.on('resize', function () {
            ...
            offsetTopSectionsArray.forEach(function (selector) {
                newOffsetTop += $(selector).outerHeight(true) || 0;
            });
            var newOffsetBottom = $('.page_footer').outerHeight(true) + $('.page_copyright').outerHeight(true);

            var affixData = $affixAside.data('bs.affix');
            if (affixData) {
                affixData.options.offset.top = newOffsetTop - offsetTopAdd;
                affixData.options.offset.bottom = newOffsetBottom + offsetBottomAdd;
